...
def get_attributes(
	...
	attributes = {
		...
		"SPIRE genome id": f"https://spire.embl.de/spire/v1/genome/{spire_genome_id}",
		"linked to SPIRE study": f"https://spire.embl.de/spire/v1/study/{spire_study_id}",
		"linked to SPIRE sample": f"https://spire.embl.de/spire/v1/sample/{spire_sample_id}",
		"SPIRE genome cluster": f"https://spire.embl.de/spire/v1/cluster/{spire_cluster}" if spire_cluster is not None else "None",
		...
		"assembly software": "megahit 1.2.9",
		...
		"taxonomic classification software": "GTDBtk v2.3.2_r214",
		"isolation_source": "missing: third party data",
		"collection date": "missing: third party data",
		"geographic location (latitude)": ("missing: third party data", "DD"),
		"geographic location (longitude)": ("missing: third party data", "DD"),
